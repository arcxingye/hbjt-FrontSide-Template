...
window.averta = {}, function(n) {
    ...
    window.CTween = {}, CTween.setPos = function(n, i) {
        ...
        n.css("opacity", 1), CTween.animate(n, t || 1e3, {
            opacity: 1
        })
    }
}(), function() {
    ...
    window.MSSlideController = function(n) {
        ...
        var slideH = $(".ms-container").height();
        this.created && (this.width = this.slider.$element[0].clientWidth || this.so.width, this.so.fullwidth || (this.width = Math.min(this.width, this.so.width)),
            this.so.fullheight ? (
                //this.so.heightLimit = !1, this.so.autoHeight = !1,
                this.height = slideH +"px" /*this.slider.$element[0].clientHeight*/
                ) : this.height = slideH +"px" /*this.width / this.slider.aspect*/,
            this.so.autoHeight ? (this.currentSlide.setSize(this.width, null, n),
                this.view.setSize(this.width, this.currentSlide.getHeight(), n)) : this.view.setSize(this.width, this.so.heightLimit ? Math.min(this.height, this.so.height) : this.height, n), this.slider.$controlsCont && this.so.centerControls && this.so.fullwidth && this.view.$element.css("left", Math.min(0, -(this.slider.$element[0].clientWidth - this.so.width) / 2) + "px"), this.dispatchEvent(new MSSliderEvent(MSSliderEvent.RESIZE)))
    ...
    t.slideAction = function() {}, t.setup = function() {
        ...
        n ? (this.$element.css("opacity", 1), this.$element.css("display", "block")) : CTween.fadeOut(this.$element, 400, !1), this.$element.removeClass("ms-ctrl-hide")
    }, t.visible = function() {
    ...
    i.extend(BaseControl), t = i.prototype, r = BaseControl.prototype, t.setup = function() {
        ...
        if (n) {
            this.$prev.css("opacity", 1).css("display", "block"), this.$next.css("opacity", 1).css("display", "block");
            return
        }
        CTween.fadeOut(this.$prev, 400, !1), CTween.fadeOut(this.$next, 400, !1), this.$prev.removeClass("ms-ctrl-hide"), this.$next.removeClass("ms-ctrl-hide")
    }, t.visible = function() {
